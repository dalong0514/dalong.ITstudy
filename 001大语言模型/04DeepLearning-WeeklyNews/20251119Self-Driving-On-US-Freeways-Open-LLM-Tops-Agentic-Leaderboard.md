## 20251119Self-Driving-On-US-Freeways-Open-LLM-Tops-Agentic-Leaderboard

[Self-Driving On U.S. Freeways, Open LLM Tops Agentic Leaderboard, Anthropic Sparks Controversy, and more...](https://www.deeplearning.ai/the-batch/issue-328/)
...
我刚参加完 AI Dev x NYC 大会回来。这是一个我们开发者社区齐聚一堂，花一整天时间编程、学习和交流的盛会。现场气氛真是热火朝天！说起来，正是在上次旧金山的 AI Dev 活动上，我结识了 Kirsty Tan，并和她开始合作，后来共同创立了我们的 AI 咨询公司 AI Aspire。线下的见面总能碰撞出新的机遇，希望在未来几个月里，能听到更多从这次 AI Dev x NYC 萌芽的故事！
...
此次活动充满了关于 AI 辅助编程、AI 智能体（AI Agent）、上下文工程（Context Engineering）、治理（Governance），以及在初创公司和大型企业中构建与扩展 AI 应用的讨论。然而，我从中获得的最深刻印象是，尽管外界对人工智能的看法悲喜交加，但在我们这一领域内部，却洋溢着近乎普遍的乐观情绪。
...
例如，许多企业尚未能通过 AI 应用实现显著的投资回报率（ROI），一些对 AI 持怀疑态度的人士还在引用麻省理工学院（MIT）的一项研究，该研究称高达 95% 的 AI 试点项目都以失败告终。（顺带一提，这项研究本身存在方法论缺陷，导致其结论标题颇具误导性。）然而，在 AI 开发者大会（AI Dev）上，汇聚了许多正是那些成功且快速增长的一系列 AI 应用背后的开发团队。通过与同行开发者交流，我意识到，正是由于 AI 在企业中的整体渗透率还很低，所以（a）许多企业确实尚未从 AI 中获得显著回报，与（b）众多经验丰富的 AI 团队正开始实现显著的 ROI，并且成功的 AI 项目数量正在快速增加 —— 尽管起点还比较低 —— 这两种情况可以同时成立。这正是 AI 开发者们对即将到来的增长浪潮如此乐观的原因！
...
好几位参展商都告诉我，这是他们很久以来参加过的最棒的会议，因为他们有机会和真正的开发者们面对面交流。其中一位提到，很多其他会议感觉内容比较空泛，而 AI Dev 的参会者技术功底扎实得多，因此对前沿技术的各种精妙细节既感兴趣，也能理解透彻。无论是讨论智能体（AI Agent）工作流的可观测性、AI 编程中上下文工程（Context Engineering）的微妙之处，还是辩论用于训练大语言模型的强化学习（Reinforcement Learning）模拟环境会继续涌现多久，会场里都汇聚了深厚的专业知识，让我们能够一起看得更远，更清晰地预见未来。
...
让我印象深刻的一个时刻是，尼克·汤普森在主持一场我与米里亚姆·福格尔参与的小组讨论时，问及了治理问题。我回应道，美国近期对移民的敌对言论，是其正在采取的最糟糕举措之一，当时台下许多观众都鼓了掌。后来，尼克在一段视频中提到了这个瞬间。
...
在 AI Dev 大会上，我有幸与许多人会面交流，对此我深感愉快。我要感谢所有前来参与的朋友，以及我们所有的演讲者、参展商、赞助商、志愿者和活动工作人员。我唯一的遗憾是，尽管本次活动的规模相比上一次旧金山场次扩大了三倍，但由于场地容量有限，我们最终还是不得不限制门票的发放数量。
...
尽管如今许多工作都在线上完成，但线下活动有其不可替代的价值，甚至可能成为个人或项目发展的转折点。我们计划将下一届 AI Dev（AI Dev）大会 —— 定于 2026 年 4 月 28 日至 29 日在旧金山举行 —— 打造为一场规模更盛大的活动，并期待此次会议能在未来助力激发更多的分享与连接。
...
Waymo 成为美国首家在高速公路上提供完全自主、无人驾驶出租车服务的公司。
...
最新动态：Waymo 的自动驾驶车队现已开始在加利福尼亚州的旧金山、洛杉矶以及亚利桑那州的凤凰城的高速公路上为付费乘客提供服务。只要用户在 Waymo 应用程序中勾选了「使用高速公路」的偏好选项，并且应用判断走高速能大幅缩短行程时间，即可使用这项服务。
...
其运作方式是：Waymo 在旧金山湾区运营着数千辆自动驾驶汽车，并提供了该区域高速公路服务最为详尽的信息。该公司的车辆正穿梭于旧金山与圣何塞之间、沿边界环绕约 260 平方英里区域的高速公路上，将行程时间缩短了高达 50%。

1 Autonomous vehicles have shuttled employees, members of the press, and other guests on freeways for more than a year.

自动驾驶汽车在高速公路上搭载员工、媒体记者及其他乘客，已安全运行超过一年。

2 The vehicles were tested on millions of miles on public roads, closed courses, and simulated roads to gather sufficient examples of traffic maneuvers, system failures, crashes, and transitions between freeways and surface streets. The company generated redundant synthetic scenarios and produced varied training examples by tweaking variables related to the vehicle's behavior, the actions of others, and environmental conditions.

这些车辆在公共道路、封闭测试场和模拟环境中进行了长达数百万英里的测试，以收集充足的驾驶行为、系统故障、碰撞事故以及高速路与普通道路切换等各种场景的数据。该公司生成了大量合成场景，并通过调整车辆自身行为、其他交通参与者的动作以及环境条件等相关变量，创造了多样化的训练样本。

3 In addition, the company is concerned with managing the  psychological impact of autonomous freeway driving, Waymo co-CEO Tekedra Mawakana said. Riders in self-driving vehicles surrender control, and this may be more worrisome at 65 miles per hour than at lower speeds, she said.

Waymo 联合首席执行官 Tekedra Mawakana 表示，公司还关注如何管理高速公路自动驾驶带来的心理影响。她指出，乘坐自动驾驶车辆的乘客放弃了控制权，而在时速 65 英里（约 105 公里）的情况下，这种失控感可能比低速行驶时更令人担忧。

4 The company worked with the California Highway Patrol to develop protocols for autonomous freeway driving.

该公司与加州公路巡逻队合作，共同制定了高速公路自动驾驶的相关协议。

5 The California Public Utilities Commission had approved Waymo's vehicles for freeway driving in March 2024 as part of a plan that includes adding more cars to the city's streets and operating at any hour.

作为一项更广泛计划的一部分，加州公共事业委员会已于 2024 年 3 月批准 Waymo 的车辆在高速公路上行驶。该计划还包括在城市街道上部署更多车辆，并允许其全天候运营。
...
背景故事：Waymo 的起源可以追溯到 21 世纪中期，当时斯坦福大学的赛车团队为了参加 DARPA 大挑战赛和 DARPA 城市挑战赛这两项自动驾驶汽车赛事，制造了参赛车辆。谷歌在 2009 年接手了这个项目，并于 2016 年底将其剥离，成立了独立的 Waymo 公司。

1 It currently operates in Atlanta, Austin, Los Angeles, Phoenix, and San Francisco and has announced plans to expand into Dallas, Denver, Detroit, Las Vegas, Miami, Nashville, San Diego, and Seattle with several other cities on the drawing board including London and Tokyo.

其服务目前已覆盖亚特兰大、奥斯汀、洛杉矶、凤凰城和旧金山，并已宣布计划进军达拉斯、丹佛、底特律、拉斯维加斯、迈阿密、纳什维尔、圣迭戈和西雅图。此外，伦敦和东京等数个其他城市也已列入发展规划。

2 Although its safety record is not pristine — in September, a Waymo car killed a pet cat in San Francisco — the company claims that its cars have experienced 91 percent fewer injury-or-worse crashes and 92 percent fewer pedestrian crashes with injuries than human drivers who drive the same distances in the same area.

虽然它的安全记录并非毫无瑕疵 —— 例如在 9 月，一辆 Waymo 的自动驾驶汽车在旧金山导致一只宠物猫死亡 —— 但该公司宣称，与在相同区域行驶同等里程的人类驾驶员相比，其车辆导致的致伤或更严重事故数量减少了 91%，导致行人受伤的事故数量也减少了 92%。

3 In 2024 and 2025, the U.S. National Highway Transportation Safety Administration opened separate investigations into Waymo for alleged violations of traffic laws.

2024 年与 2025 年，美国国家公路交通安全管理局（NHTSA）就 Waymo 涉嫌违反交通法规的行为，分别启动了调查。
...
其重要性在于：能够在高速公路上运行，对于自动驾驶汽车完全替代人类驾驶至关重要。实现完全自主的高速公路驾驶，是 Waymo 一个重大的技术突破。因为其车辆需要从城市道路驾驶平稳地切换到高速公路驾驶，而高速公路的管控相对宽松，系统必须进行更长远的规划，并在更高的车速下更快地做出反应以适应路况变化。此外，获得政府批准让 Waymo 汽车驶上高速公路，从监管和社会层面来看都是一项巨大成就。该公司成功说服了监管机构，认为自动驾驶汽车上路所带来的益处，超过了其在安全与公众信任方面可能引发的潜在风险。Waymo 宏大的扩张计划表明，这仅仅是其未来更多里程碑中的第一个。
...
我们不禁想到：Andrew 还留着当年参加 DARPA 城市挑战赛时的那件 T 恤。他依然记得那时的乐观氛围，也深知开发出真正能上路的自动驾驶汽车，所花费的时间远比早期预测的要漫长。如今，既有 Waymo 的机器人出租车，也有特斯拉的全自动驾驶（受监督）功能，问题已不再是这项技术能否普及，而是它何时会普及。
...
Moonshot AI 发布的最新开源大语言模型，在智能体任务中向顶级专有模型发起了挑战。其方法是顺序执行数百个工具调用，并在每次调用之间暂停下来进行「思考」。
...
确实如此，但需注意：在完成 Artificial Analysis 的 Intelligence Index 评估时，Kimi K2 Thinking 消耗了 1.4 亿个 Token，超过了所有参与测试的其他大语言模型。其用量大约是 DeepSeek-V3.2 Exp（6200 万 Token）的 2.5 倍，也是 GPT-5 Codex 设置为高推理模式（7700 万 Token）的两倍。就运行 Intelligence Index 测试的成本而言，Kimi K2 Thinking（356 美元）比设置为高推理模式的 GPT-5（913 美元）便宜了大约 2.5 倍，但价格却比 DeepSeek-V3.2 Exp（41 美元）高出近 9 倍。
...
新闻背后：今年七月，Moonshot 公司开源了 Kimi K2 模型的权重。这个版本并非专注于推理能力，而是针对智能体任务（Agentic Tasks）—— 例如调用工具、解决需要多步骤的复杂问题 —— 进行了专门优化。
...
为什么这一点很重要：AI 智能体（AI Agent）应用的优势在于，它能够无需人类插手，就完成跨越多次工具调用的复杂推理。Kimi K2 Thinking 正是为应对这类多步骤任务而设计的，诸如资料研究、编写代码和浏览网页等。采用 INT4 精度量化后，该模型得以在更廉价、更普及的芯片上运行 —— 这在中国市场尤其是一大优势，因为获取最尖端硬件存在限制 —— 或者，它也能以极高的速度执行任务。
...
我们的看法是：大语言模型正变得越来越聪明，它们能更好地判断何时需要深入思考、何时应该调用工具，以及如何让思考与工具使用相辅相成。根据早期报告，Kimi K2 Thinking 所具备的规划与实时反应能力，在从科学研究、网页浏览到创意写作等多种应用中都能提供助力 —— 值得一提的是，在创意写作这类任务上，具备复杂推理能力的模型其表现有时反而不如推理能力较弱的模型。

#### Anthropic Cyberattack Report Sparks Controversy

Anthropic 网络攻击报告引发争议
...
独立的网络安全研究人员反驳了 Anthropic 公司的一份报告。该报告声称，黑客利用其 Claude Code（一种 AI 智能体编码系统）实施了一场前所未有的自动化网络攻击。
...
最新动态：Anthropic 在一篇博客文章中披露，他们成功挫败了一场由某国政府赞助的黑客在九月发起的攻击活动，并将其称为「首个有记录的大规模、无需大量人工干预的网络攻击案例」。然而，据 Ars Technica 报道，一些独立研究人员指出，目前的 AI 智能体（AI Agent）尚不具备执行此类恶意攻击的能力。此外，极低的成功率 —— 数十次尝试中仅成功了几次 —— 也削弱了 Anthropic 关于「此次 AI 智能体攻击事件揭示了新的危险能力」的说法。由于 Anthropic 公开的细节有限，外界难以全面评估其声明的真实性。
...
Claude 遭攻破：根据 Anthropic 的报告，黑客通过角色扮演，伪装成一家安全公司的员工，以测试其网络为名，绕过了 Claude Code 的安全护栏。
...
* 他们引导 Claude Code 以一系列小步骤来探测、侵入并提取网络数据，而这些步骤并未被其底层模型识别为恶意行为。随后，Claude Code 以远超传统黑客手段的速度执行了这些操作。
...
* 据《华尔街日报》报道，具备自主行动能力的 AI（Agentic AI）完成了其中 80% 至 90% 的技术步骤，人类仅需偶尔发出诸如「是的，继续」、「不要继续」或「哦，这看起来不太对，Claude，你确定吗？」等指令进行干预。
...
* 入侵者瞄准了至少 30 家组织，并成功从其中数家窃取了敏感信息。
* 该报告既未指明遭攻击的组织，也未说明其攻击侦测方式以及与中国的关联依据。据《纽约时报》报道，中国外交部发言人对此表示，中方不支持黑客行为。
...
质疑的原因：一些接受 Ars Technica、The Guardian 等媒体采访的独立安全研究人员，提出了多条理由来质疑这份报告。
...
* 尽管他们一致认为人工智能（AI）能够加速日志分析、逆向工程等任务，但他们也发现，AI 智能体目前还无法在无人干预的情况下执行多步骤任务。此外，在自动化网络攻击方面，它们的效果并未显著优于几十年前就已存在的黑客工具。"威胁行为者并没有创造出什么新东西，」研究员 Kevin Beaumont 在一个在线安全论坛上表示。
...
* Anthropic 表示，除了 Claude Code，黑客还使用了常见的开源工具。然而，安全专家对这些常见工具的防御手段也同样熟悉，目前尚不清楚 Claude Code 将如何改变这一局面。
...
* Anthropic 公司自己指出，Claude Code 所声称窃取的信息很可能是它自己「产生幻觉」（hallucinated）编造出来的，因为该模型「经常夸大其词」并且「偶尔还会伪造数据」。该公司表示，这种不可靠的行为是将其系统用于实施网络攻击的一个主要障碍。
...
新闻背后：黑客们经常利用人工智能（AI）来加速或自动化其犯罪活动，例如编写更具欺骗性的钓鱼邮件，或是生成恶意代码。今年八月，人工智能公司 Anthropic 指出了「情绪黑客」(vibe hacking）的兴起。在这种趋势下，一些技术能力有限的恶意分子开始借助 AI 工具，从事以往只有技术高超的程序员才能实施的非法行为。同月，Anthropic 报告称，其成功挫败了一起此类犯罪企图，该行动涉及窃取个人数据并进行勒索。十月，白宫人工智能事务负责人大卫·萨克斯（David Sacks）指责 Anthropic 推行了一种「基于散布恐惧的、复杂的监管捕获策略」。
...
为什么这很重要： 一个合理的推测是，人工智能（AI）能让黑客攻击变得更快、更高效，就像它提升许多日常活动的效率一样。然而，Anthropic 公司对其发现的、由 Claude 驱动的 AI 智能体（AI Agent）网络攻击的描述，与该公司之外的安全研究人员的实际体验并不相符。独立研究人员发现，AI 智能体在自动化网络攻击方面效果相对有限，而传统方法则具有同等甚至更大的危险性。安全研究人员探索 AI 智能体在制造和防御安全威胁方面的应用是正确的，但目前尚未发现其构成 Anthropic 所警示的那种严峻威胁。
...
我们的思考是：人工智能（AI）公司希望展示其产品的强大能力，但有时 —— 这看似矛盾 —— 宣传却会突出产品在导致负面结果方面的巨大作用。无论结果好坏，炒作本身都是有害的。我们希望，那些开发尖端模型及其应用的团队，能够找到恰当的方式来宣传他们的成果 —— 其中许多成果确实令人赞叹和激动！—— 同时避免误导或混淆公众。在网络安全领域，由 AI 驱动的安全漏洞检测让修补工作变得更加容易。这样一来，AI 帮助改变了攻防态势，将优势从攻击者一方转移到了防御者一方，从而让计算机变得更加安全。
...
大语言模型可能已经掌握了与给定提示相关的知识，但它们并不总能稳定地提取这些信息。通过微调模型，使其像在网络上搜索一样去检索自身的参数，可以帮助模型从自身权重中发掘知识。
...
最新进展：Yuchen Fan 与来自清华大学、上海交通大学、上海人工智能实验室、伦敦大学学院、中国建筑第三工程局以及微信 AI 的研究团队共同提出了自搜索强化学习（Self-Search Reinforcement Learning，SSRL）。该方法通过模拟从生成查询到最终给出答案的完整搜索流程，来训练大语言模型（LLM）进行问答。根据研究团队的测试结果，SSRL 能够有效提升模型性能，无论该模型是否具备接入网络搜索工具的能力。
...
核心发现：作者们发现，大语言模型（LLM）在生成 1000 个回答时，给出正确答案的几率要高于只生成少量回答时。这说明大语言模型并非总能调用其已有的知识进行回答。在通过强化学习进行微调的过程中，模拟搜索（即要求模型先生成一个查询，再针对该查询生成回答，仿佛它正在网上搜索一样），可以增强模型从其自身参数中提取信息的能力。
...
工作原理：作者采用强化学习算法 —— 组相对策略优化（Group Relative Policy Optimization，GRPO）—— 对 Llama-3.1-8B、Qwen2.5-7B 等预训练模型进行微调。微调后的模型通过执行一系列步骤（包括推理和模拟搜索）来回答 Natural Questions 和 HotpotQA 数据集中的问题。模型学会了首先生成一系列的思考、查询以及自我生成的信息，并在需要时多次循环这一过程，最终才得出答案。

* The model generated text following a specific format, using  <think>, <search>, <information> (self-generated search responses), and <answer> tags to structure its reasoning process.

* 模型按照特定格式生成文本，使用 <think>、<search>、<information>（自生成的搜索结果）和 <answer> 标签来组织其推理过程。
...
*  作者会奖励模型，因为它能正确给出最终答案并遵循指定格式。
*  系统在计算损失时，会忽略 `<information>` 标签之间的 tokens（Token）。这能鼓励模型将注意力集中在用户查询和推理过程上，而不是去死记硬背它自己可能生成的任何错误信息。
...
结果：研究团队在六个问答基准数据集（包括 Natural Questions、HotpotQA 以及其他四个数据集）上对 SSRL（Self-Supervised Retrieval Learning）进行了评估，并将其与那些依赖外部搜索引擎的方法进行了对比。采用 SSRL 方法训练的模型，其表现通常优于那些单纯依赖搜索的基线模型。此外，通过 SSRL 学到的检索技能，即使当模型后续被赋予调用外部搜索引擎的能力时，也能进一步提升它的性能。
...
* 在各项基准测试中，一个经过 SSRL 训练的 Llama-3.1-8B 模型，其答案完全正确的平均比例为 43.1%。ZeroSearch 模型在训练时使用一个独立的、经过微调的 Qwen-2.5-14B-Instruct 来回答查询，在测试时则改用 Google，其答案完全正确的比例为 41.5%。而专为使用 Google 搜索而训练的 Search-R1 模型，这一比例为 40.4%。
...
* 在四个使用 SSRL 进行训练的模型中，有三个在采用谷歌搜索（而非自行生成答案）后，性能得到了提升。例如，一个 Qwen2.5-7B 模型的平均得分从仅使用 SSRL 时的 30.2% 提升到了结合 SSRL 与谷歌搜索后的 46.8%。
...
其重要性在于：对于基于大语言模型（LLM）的 AI 智能体来说，模拟训练与现实表现之间的差距往往是一大难题。然而，这项研究发现，那些被训练来模拟网络搜索的大语言模型，实际上能够更高效地进行真实的网络搜索。这一结果证明，在处理知识型任务时，大语言模型自身的参数就能充当一个既经济又逼真的模拟器。
...
我们的想法是：AI 智能体（AI Agent）在决定是否需要联网搜索时可以更加审慎。本研究提出了一种混合策略：智能体首先利用自身掌握的内部知识进行判断，仅在发现知识存在缺口时，才转向互联网进行搜索。
