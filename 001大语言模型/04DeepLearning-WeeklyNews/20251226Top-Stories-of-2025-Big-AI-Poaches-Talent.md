## 20251226Top-Stories-of-2025-Big-AI-Poaches-Talent

[Top Stories of 2025! Big AI Poaches Talent, Reasoning Models Boost Performance, Agents Write Code, Data Centers Drive GDP, and more...](https://www.deeplearning.ai/the-batch/issue-333/)
...
人工智能（AI）又迎来了一年飞速发展，这为每个人 —— 包括刚刚踏入这个领域的新人 —— 创造了前所未有的软件开发机遇。事实上，很多公司现在正苦于找不到足够多的熟练 AI 人才。每年寒假，我都会花些时间学习和动手实践，希望你们也能如此。这不仅能帮我温故知新，也能助力你在科技领域的职业生涯更上一层楼。
...
3 (Optionally) read research papers
...
我听到有些开发者建议别人，只管直接动手开发项目，而无需先系统学习。这种建议并不可取！除非你本身就处在一个经验丰富的 AI 开发者社群中，否则，如果对 AI 的基础原理一无所知就直接动手，你将面临「重新发明轮子」的风险 —— 或者更可能的情况是 —— 发明出一个更差的轮子！
...
例如，在面试求职者时，我曾遇到过一些开发者，他们重新发明了标准的 RAG 文档分块策略，重复造轮子般地复现了现有的 AI 智能体（AI Agent）评估技术，或者最终写出了一团糟的大语言模型上下文管理代码。如果他们之前学习过几门相关课程，就能更好地理解那些现有的基础构建模块。他们当然仍可以选择从头构建这些模块，甚至可能创造出优于现有方案的成果，但首先通过课程学习，本可以帮助他们节省数周不必要的重复劳动。所以说，系统化的学习非常重要！此外，我发现学习课程确实充满乐趣。与其刷剧，我更愿意花时间观看由资深 AI 专家讲授的课程！
...
与此同时，仅仅上课是远远不够的。有很多知识和技能，你只能通过亲自动手实践才能真正掌握。学习飞机运作的理论对成为一名飞行员至关重要，但从未有人仅靠上课就学会了驾驶飞机。在某个时刻，你必须坐进驾驶舱亲自操作，这至关重要！好消息是，通过学习使用高度自主的 AI 智能体编码器（highly agentic coders），构建过程变得比以往任何时候都更加简单。而了解人工智能构建模块（AI building blocks）可能会激发你产生许多想要构建的新项目的灵感。当我对于要做什么项目缺乏灵感时，我通常会去上课或者阅读研究论文，这样做一段时间后，我总是能收获许多新想法。此外，我发现动手构建的过程真的充满乐趣，希望你也能够乐在其中！
...
最后，并非每个人都必须这么做，但我发现，如今就业市场上许多实力最强的求职者，至少都会偶尔阅读研究论文。虽然我觉得研究论文比课程难懂得多，但它们包含了大量尚未被整理成更易懂形式的知识。我把阅读论文的优先级，远排在参加课程或动手实践之后，但如果你有机会提升自己阅读论文的能力，我强烈建议你也去尝试。（你也可以观看我过去一个关于如何阅读论文的建议视频。）我觉得上课和做项目很有趣，而读论文可能更像一件苦差事，但从论文中获得的那些顿悟时刻，着实令人欣喜。
...
祝你寒假愉快，新年快乐！除了学习和耕耘（比如构建项目或提升技能），我也希望你能多花时间陪伴爱你的人 —— 这一点，同样非常重要！
...
2025 年，或许会被后人视为人工智能（AI）产业时代的开端。创新不断涌现，将模型性能推至新的高峰；由 AI 驱动的应用变得无处不在，不可或缺；顶尖企业为争夺人才激烈交锋；而相关基础设施的建设，更是直接拉动了美国的国内生产总值。与历年年末假日季一样，本期《The Batch》年度特刊回顾了过去 12 个月的核心主题。展望来年，随着这项技术更深地融入日常生活的方方面面，这些变革有望得到进一步巩固。
...
采用「逐步思考、解释推理过程、从答案倒推」这类策略，曾经需要明确的指令。在 2025 年初，大语言模型还只有在被提示时才会执行这些推理策略。如今，大多数新模型已经将其作为标准流程，从而在各种任务上普遍提升了性能。
...
事情是这样的：去年年底，OpenAI 推出了其首个具备推理（或「思考」）能力的模型 —— o1，该模型融入了智能体（Agentic）推理工作流程。到了今年一月，DeepSeek-R1 又向世界展示了如何实现类似功能。带来的结果是立竿见影的：数学和编程能力得到提升，问题回答更加准确，机器人变得更强大，AI 智能体领域也取得了快速进展。
...
故事的起点：一种早期的推理能力随着一篇名为《大语言模型是零样本推理者》的论文而崭露头角，该论文引入了「让我们一步一步地思考」这个提示附加语。作者发现，在给模型的提示词中手动加入这句话，能显著改善其输出结果。研究人员很快意识到，他们可以通过训练将这种能力内化到模型中，使得模型即使在没有收到明确指令时，也能自发运用这种及其他推理策略。其中的关键在于**强化学习微调**。具体方法是：对预训练好的大语言模型，如果它给出了正确答案就给予奖励。通过这种方式，模型被训练成在生成最终答案前，会先进行一番内部「推敲」。

1 The first few reasoning models were trained via RL specifically to solve math problems correctly, answer science questions accurately, and/or generate code that passed unit tests. This enabled o1-preview, for instance, to outperform its non-reasoning predecessor GPT-4o by 43 percentage points on AIME 2024 (competition math problems) and 22 percentage points on GPQA Diamond (PhD-level science questions), while it completed Codeforces' coding problems in the 62nd percentile relative to competitive human coders, compared to GPT-4o's 11th percentile.

最早的一批推理模型（reasoning models）是专门通过强化学习（RL）训练的，旨在解决数学问题、回答科学问题以及生成能通过单元测试的代码。例如，这使得 o1-preview 在 AIME 2024（数学竞赛题）上的表现比其非推理前身 GPT-4o 高出 43 个百分点，在 GPQA Diamond（博士级科学问题）上高出 22 个百分点。同时，在 Codeforces 的编程挑战中，o1-preview 的解题能力排名达到了参赛人类程序员的第 62 百分位，而 GPT-4o 仅排在第 11 百分位。

2 Reasoning models performed even better when they learned to use tools like calculators, search engines, or bash terminals. For example, on a challenging test of multimodal understanding and technical expertise in 100 domains, OpenAI o4-mini with tools achieved 17.7 percent accuracy, more than 3 points higher than it managed without tools.

如果推理模型学会了使用工具，比如计算器、搜索引擎或 bash 终端，它们的性能还会进一步提升。例如，在一项涵盖 100 个不同领域、涉及多模态理解与技术专业知识的极具挑战性的测试中，能够调用工具的 OpenAI o4-mini 模型取得了 17.7% 的准确率，比不使用工具时高出了 3 个多百分点。

3 Robotic action models have been trained to reason via RL. For example, rewarding ThinkAct for reaching a goal position yielded roughly an 8 percent performance improvement on robotics tasks compared to non-thinking models like OpenVLA.

机器人动作模型已经通过强化学习（Reinforcement Learning，RL）训练，从而具备了推理能力。举例来说，在机器人任务中，通过奖励 ThinkAct 模型使其达成目标位置，与 OpenVLA 这类不具备推理能力的模型相比，其性能提升了大约 8%。

4 Reasoning models also help agents to tackle difficult problems. For instance, AlphaEvolve used Google Gemini to repeatedly generate, evaluate, and change code, ultimately producing faster algorithms for real-world problems. Similarly, AI Co-Scientist used Gemini to generate scientific research proposals and then review, rank, and improve them. Among other results, it proposed a hypothesis to answer a longstanding question about microbial resistance to antibiotics. Human scientists independently proposed and validated the same hypothesis at about the same time.

推理模型也能帮助 AI 智能体攻克难题。例如，AlphaEvolve 项目利用 Google Gemini 反复生成、评估和修改代码，最终为现实世界的问题开发出了更快的算法。无独有偶，AI Co-Scientist 项目则使用 Gemini 来生成科学研究提案，随后对这些提案进行审查、排序和优化。其中一项突出成果是，它提出了一个假说，用以解答一个困扰科学界已久的难题：微生物如何对抗生素产生耐药性。值得注意的是，人类科学家在大约同一时期也独立地提出并验证了相同的假说。

Yes, but: Reasoning models may not be as rational as they seem.

没错，不过：推理模型可能并不像看起来那么理性。

1 In a controversial paper, Apple concluded that reasoning models couldn't solve puzzles beyond a certain level of complexity, even when the models were given algorithms that solved them. The models' inability to apply the algorithms calls into question apparent similarities between machine and human reasoning.

在一篇颇具争议的论文中，苹果公司的研究人员得出结论：即使为模型提供了能够解决特定谜题的算法，推理模型（reasoning models）也无法处理复杂度超过一定阈值的谜题。模型未能成功运用这些算法，这引发了人们对机器推理与人类推理之间表面相似性的质疑。

2 Anthropic found that, while a model's reasoning steps can help to explain how it reached a conclusion, they may also omit crucial information that contributed to the conclusion. For instance, reasoning models can be led to produce a particular output by including a hint in the prompt, but their reasoning steps may fail to mention the hint.

Anthropic 的研究发现，虽然模型的推理步骤有助于解释其得出结论的过程，但也可能遗漏了得出该结论所依赖的关键信息。例如，研究人员可以在给模型的提示（Prompt）中加入一个暗示（Hint），从而引导模型产生某个特定输出；然而，模型在展示其推理步骤时，却可能完全不提及这个暗示。
...
现状：推理能力能显著提升大语言模型的性能。然而，这种性能的提升是有代价的。根据 Artificial Analysis 的 Intelligence Index 基准测试结果，启用推理功能的 Gemini 3 Flash 消耗了 1.6 亿个 Token（得分 71），而未启用推理的版本仅消耗 740 万个 Token（得分 55，低得多）。此外，生成用于推理的 Token 会导致输出延迟，这给大语言模型推理服务提供商带来了必须更快输出 Token 的压力。不过，研究人员正在寻找提升效率的方法。例如，Claude Opus 4.5 与启用高强度推理模式的 GPT-5.1 在 Intelligence Index 中获得了相同的分数，但前者消耗了 4800 万个 Token，后者则消耗了 8100 万个。

#### A Big AI Lures Talent With Huge Pay
...
领先的 AI 公司为争夺顶尖人才展开了激烈竞争，它们开出堪比职业体育明星的天价薪酬，从竞争对手那里大肆挖角。
...
发生了什么：七月，Meta 启动了大规模招聘，为其新成立的 Meta 超级智能实验室（Meta Superintelligence Labs）招兵买马，向来自 OpenAI、Google、Anthropic 等顶尖 AI 公司的研究人员开出了总额可能高达数亿美元的薪酬方案。这些方案包括丰厚的现金奖金，以及对其因跳槽而损失的原有公司股权进行补偿。相应地，Meta 的竞争对手们也反过来从 Meta 以及彼此之间挖走关键员工，这使得 AI 顶尖人才的薪酬被推至前所未有的高位。
...
事件的驱动力：Meta 公司彻底颠覆了传统的薪酬结构，其提供的薪酬方案为期四年，总价值可高达 3 亿美元，其中的流动性薪酬（Liquid Compensation）部分，有时甚至远超其他公司那些需要多年才能完全归属（Vest）的股票期权。据《华尔街日报》报道，在成功聘请了 Scale AI 的首席执行官 Alexandr Wang 及其团队的核心成员后，Meta 的首席执行官 Mark Zuckerberg 又拟定了一份新的目标名单。
...
* 扎克伯格亲自上门游说，劝人跳槽，有时还会带上自家熬的汤。这番努力成功招揽了多位人才，其中包括来自 OpenAI 的 Jason Wei 和 Hyung Won Chung，这两位研究员主要专注于推理模型的研究。
...
* 据《华尔街日报》报道，Andrew Tulloch 最初拒绝了 Meta 提供的一份价值高达 15 亿美元的奖金薪酬方案。他曾与 OpenAI 前首席技术官 Mira Murati 共同创立了 Thinking Machines Lab。几个月后，他改变了主意，选择加入 Meta。
...
* 据彭博社报道，Meta 聘请了曾在苹果公司负责 AI 模型研发的 Ruoming Pang。这份薪酬方案在数年内的总额高达数亿美元。Meta 的报价甚至超过了苹果公司除首席执行官外的其他最高层管理人员的薪酬，苹果方面最终选择不进行还价。
...
* 在此次人事变动中，微软人工智能首席执行官穆斯塔法·苏莱曼从谷歌吸纳了二十多名研究人员和工程师，其中包括曾任工程副总裁的阿马尔·苏布拉马尼亚。
...
* 埃隆·马斯克旗下的人工智能公司 xAI 从 Meta 挖来了十多名 AI 研究员和工程师。马斯克抨击了竞争对手「疯狂」的薪酬报价，同时宣扬自家公司「极度崇尚绩效」的文化以及股权价值增长的更大潜力。
...
新闻背后：人工智能（AI）工程师的薪资走势，折射出 AI 从一项学术探索发展为革命性技术的历程。
...
* 2011 年，Google Brain 在吴恩达的领导下成立之初，人工智能（AI）人才还主要聚集在学术界。随着神经网络技术被整合到搜索引擎和智能助手等商业产品中，机器学习工程师这一职位也逐渐在企业中成为了一个标准化的岗位层级。
...
* 2014 年谷歌收购 DeepMind 时，人工智能领域从业者的薪酬已显著超过软件工程师的普遍水平。据《纽约时报》估计，当时 DeepMind 每位员工的平均成本约为 34.5 万美元。到了 2017 年，随着谷歌推出 Transformer 架构，该领域的顶级薪酬已上涨到 50 万美元。
...
* 大约 2023 年，随着 ChatGPT 的兴起，薪酬水平再次大幅上涨。据一份报告称，顶尖软件工程师的薪资待遇甚至超过了 70 万美元。
...
当前形势：进入 2026 年，人工智能（AI）领域的招聘市场已今非昔比。据《华尔街日报》报道，为了在人才争夺战中保持竞争力，OpenAI 提供了比同行更丰厚的股权薪酬，缩短了新员工所获股票期权的兑现周期，并开出了高达 150 万美元的留任奖金。尽管 2025 年出现了关于 AI 泡沫的议论，但对于那些计划投入数百亿美元建设 AI 数据中心的公司而言，支付高薪是合乎逻辑的 —— 既然在硬件上不惜重金，为何不将其中的一小部分用于招揽人才呢？
...
顶级人工智能公司宣布了建设数据中心的计划，预计在未来几年内将耗费数万亿美元的资金和数十吉瓦的电力。
...
发生了什么：人工智能（AI）行业的资本支出今年一年就突破了 3000 亿美元，这笔巨资大部分都投向了建设新的数据中心，以处理 AI 计算任务。这还只是一个初步预算，因为各大公司已经制定了雄心勃勃的计划，要建造规模如同小镇、耗电量堪比中等城市的数据中心设施。咨询公司麦肯锡（McKinsey & Company）预测，为了打造足够的算力以满足未来对 AI 推理（inference）和训练（training）的预期需求，这场建设竞赛到 2030 年可能会耗费高达 5.2 万亿美元。
...
核心动态：顶尖 AI 公司接连宣布了在全球范围内部署的一系列数据中心项目。每千兆瓦的数据中心算力容量，其建设成本大约需要 500 亿美元。
...
* 1 月，OpenAI 与甲骨文、软银和阿联酋投资公司 MGX 合作，启动了一项名为 Stargate、耗资 5000 亿美元的项目。该公司还宣布了在全球范围内建设 20 吉瓦数据中心容量的计划，并预测未来需求可能高达该容量的 5 倍。OpenAI 首席执行官 Sam Altman 表示，他希望最终能实现每周增加 1 吉瓦容量的目标。
...
* Meta 在 2025 年投入了约 720 亿美元用于基础设施建设，这些项目主要位于美国。公司高管表示，这一投资额在 2026 年还将大幅增长。其 Hyperion 项目包含一个建在路易斯安那州乡村、价值 270 亿美元、功率达 5 吉瓦的数据中心。该项目的融资安排将使相关资产和债务保持为表外项目（off-balance-sheet），不会计入 Meta 的资产负债表。
...
* 2025 年，微软在全球数据中心项目上投入了 800 亿美元，其中包括威斯康星州和亚特兰大的设施。这些数据中心将通过专用光纤网络相连，以构成一台巨型超级计算机。为确保电力供应，微软签署了一份为期 20 年的协议，重启位于宾夕法尼亚州的三里岛核电站，该电站将从 2028 年起提供 835 兆瓦的电力。此外，微软还承诺将其在欧洲的云服务与 AI 算力基础设施扩展至 200 个数据中心，遍布欧洲各地。
...
* 亚马逊预计在 2025 年将投入 1250 亿美元用于基础设施建设，并且在 2026 年的投入会更多。其耗资 110 亿美元的「Project Rainier」项目，是一个位于美国印第安纳州、功率高达 2.2 吉瓦的数据中心，该数据中心将搭载 50 万颗亚马逊自研的 Trainium 2 芯片。此外，亚马逊还计划在 2025 年至 2029 年间，投资约 140 亿美元用于扩建澳大利亚的数据中心，并在德国投入大约 210 亿美元。
...
* Alphabet 预计在 2025 年将投入高达 930 亿美元用于基础设施建设，这一数字高于此前 750 亿美元的预测。该公司宣布了一项总额 400 亿美元的计划，目标是在 2027 年前于德克萨斯州新增 3 个数据中心。此外，Alphabet 还承诺向印度的一个项目投资 150 亿美元，公布了在德国约 60 亿美元的投资计划，并在澳大利亚、马来西亚和乌拉圭启动或扩建了多个新项目。

Yes, but: Can the U.S. economy and infrastructure support such immense investments? There are reasons to wonder.

然而，问题在于：美国的经济和基础设施能否支撑如此规模庞大的投资？这确实令人存疑。
...
* 贝恩公司（Bain & Co）的顾问估计，数据中心的扩建支出意味着，到 2030 年，人工智能（AI）产业每年需要创造约 2 万亿美元的收入。这一数字将超过亚马逊、苹果、Alphabet、微软、Meta 和英伟达这六家公司 2024 年利润的总和。
...
* 现有电网可能难以满足这些数据中心的电力需求。据彭博社报道，硅谷有两处数据中心设施处于闲置状态，原因是当地电力公司缺乏足够的电网容量为其提供接入。
...
* 据《金融时报》报道，12 月中旬，Blue Owl Capital 退出了为 Oracle 和 OpenAI 一个价值 100 亿美元的数据中心项目提供融资的谈判。报道提及了对 Oracle 在数据中心建设过程中债务不断增长的担忧。Blue Owl 将继续为其他 Oracle-OpenAI 数据中心项目提供融资。
...
当前形势：尽管对人工智能（AI）泡沫存在担忧，但在整体经济表现平平的背景下，基础设施建设的繁荣正在创造实实在在的就业岗位并拉动销售。根据哈佛大学经济学家杰森·弗曼的说法，在 2025 年上半年，对数据中心和人工智能的投资几乎贡献了美国国内生产总值（GDP）的全部增长。现阶段，有证据支持这样一个观点：2025 年拉开了一个崭新工业时代的序幕。
...
编码应用已经超越了自动填充式的代码补全，演进为能够处理广泛软件开发任务的 AI 智能体（AI Agent）系统。
...
发生了什么：基于 AI 智能体的工作流在编码领域率先落地，并展现出最直接的商业价值。Claude Code、Google Gemini CLI 和 OpenAI Codex 等应用的推出，使得编码智能体成为了 AI 巨头们竞争最激烈的战场之一。为了留在牌桌上，规模较小的竞争对手也纷纷开发了自己的智能体模型。
...
故事主线：当开创性的智能体代码生成器（Agentic Code Generator）Devin 于 2024 年问世时，它将编码挑战基准 SWE-Bench 上的任务解决率从 1.96% 一举提升到了 13.86%。到了 2025 年，基于最新大语言模型的编码智能体，已经能够常规性地完成超过 80% 的同类任务。开发者们开始广泛采用日益复杂的智能体框架，这些框架使得大语言模型能够与智能规划器、结果评判器协同工作，调用网络搜索、终端模拟等工具，并对整个代码库进行操作。

1 When reasoning models arrived late in 2024, they immediately boosted coding power and cut costs, as reasoning enabled agents to map out tasks to be completed by less expensive models. The addition of variable reasoning budgets made it easier for agents to use a single model, devoting more tokens to planning and fewer to making simple edits. By the end of 2025, Gemini 3 Pro, Claude Opus 4.5, and GPT-5.2 emerged as top models for coding and agentic workflows.

当推理模型（Reasoning Models）在 2024 年下半年问世时，它们立即大幅提升了编码能力并降低了成本，因为推理功能使得 AI 智能体（AI Agent）能够将任务规划出来，交由成本更低的模型去执行。可变推理预算（Variable Reasoning Budgets）的引入，让智能体更容易使用单一模型，可以将更多的 Token 分配给任务规划，只分配少量 Token 处理简单的编辑工作。到 2025 年底，Gemini 3 Pro、Claude Opus 4.5 和 GPT-5.2 已成为处理编码和智能体工作流（Agentic Workflows）的顶尖模型。

2 Open-weights models quickly followed. Z.ai GLM-4.5 and Moonshot Kimi K2 emerged as open-weights favorites, enabling automated-coding startups to cut their costs dramatically. Released in July, Qwen3-Coder provided a hefty 480 billion-parameter model trained on over 5 trillion tokens of code, nearly matching the performance of Claude Sonnet 4.

开源模型迅速跟进。智谱 AI 的 GLM-4.5 和月之暗面的 Kimi K2 成为开源权重模型中的佼佼者，使得自动化编码初创公司能够大幅削减其成本。于 7 月发布的 Qwen3-Coder 提供了一个庞大的 4800 亿参数模型，该模型在超过 5 万亿代码 Token（Token）上训练，其性能几乎媲美 Claude Sonnet 4。

3 Anthropic wrapped an agentic framework around Claude to create an application: Claude Code. Introduced in February, Claude Code was an instant hit and set expectations for what agentic coding systems should do. OpenAI responded with its Codex application based on coding-specialized versions of its GPT-5 series. Where Claude Code initially ran locally, the Codex app ran in a browser, helping to popularize coding agents that run in the cloud. By the end of the year, these agents were able to manage longer-running problems using multiple sub-agents — typically an initializer to start tasks and track progress and various coding agents to complete different tasks — each with its own context window.

Anthropic 为 Claude 引入了一个 AI 智能体（AI Agent）框架，从而打造出一款应用：Claude Code。该应用于二月推出后迅速走红，并为 AI 智能体编码系统树立了功能标杆。OpenAI 随即推出了基于 GPT-5 系列编码专用版本的 Codex 应用作为回应。Claude Code 最初在本地运行，而 Codex 应用则在浏览器中运行，这推动了云端编码智能体的普及。到年底时，这类智能体已经能够通过多个子智能体来处理耗时更长的复杂问题 —— 通常包括一个用于启动任务并跟踪进度的初始化器，以及多个负责不同任务的编码智能体 —— 每个子智能体都拥有独立的上下文窗口。

4 A tug-of-war between model makers and developers of integrated development environments (IDEs) led popular IDE providers like Anysphere (Cursor) and Cognition AI (Windsurf) to build their own models. Conversely, Google built its own IDE, Antigravity, which debuted in November.

模型制造商与集成开发环境（IDE）开发商之间的竞争，促使一些主流 IDE 提供商，如 Anysphere（Cursor）和 Cognition AI（Windsurf），开始自行开发模型。另一方面，谷歌则选择了自己打造 IDE 的道路，推出了名为 Antigravity 的产品，并于十一月首次亮相。
...
新闻背后：AI 智能体（Agentic）系统在流行的 SWE-Bench 编码基准测试中稳步推进了技术前沿，研究人员也在寻找其他方法来评估其性能。

1 These efforts led to SWE-Bench Verified, SWE-Bench Pro, LiveBench, Terminal-Bench, 𝜏-Bench, CodeClash, and others.

这些努力最终产生了 SWE-Bench Verified、SWE-Bench Pro、LiveBench、Terminal-Bench、𝜏-Bench、CodeClash 等项目。

2 Because different providers trust (or cherry-pick) different benchmarks, it has become more difficult to evaluate agents' performance. Choosing the right agent for a particular task remains a challenge.

由于不同的供应商信赖（或选择性采用）不同的基准测试，评估 AI 智能体性能的难度也随之增加。因此，为特定任务选择合适的智能体仍然是一项挑战。
...
话虽如此，但情况在变化：2025 年初，大多数观察人士认为，AI 智能体（AI Agent）擅长生成普通的代码、文档和单元测试，但在处理更高阶的战略性问题时，经验丰富的人类工程师和产品经理仍然表现更优。然而到了年底，多家公司报告已经实现了对资深级别任务的自动化。微软、谷歌、亚马逊和 Anthropic 均表示，他们正在生成越来越多的内部代码。
...
现状：在很短的时间内，智能体编码（Agentic Coding）已将所谓的「氛围编码」（Vibe-coding）从一个令人费解的流行词，发展成了一个方兴未艾的产业。诸如 Loveable、Replit 和 Vercel 等初创公司，使得那些编码经验极少甚至为零的用户，也能从零开始构建网络应用。尽管一些观察者曾担忧 AI 会取代初级开发者，但实际情况表明，善于利用 AI 的开发者能够更优质、更快速地构建出应用原型。很快，AI 辅助编码或许就会像拼写检查和自动补全之于写作一样，被视作编码过程中自然而然的一部分。
...
美国政府试图切断中国 AI 算力的努力适得其反，反而促使中国出台了针对美国设计芯片的禁令。
...
事件背景：据路透社 11 月报道，中国政府发布指令，要求所有新建的国有资金数据中心必须采用国内供应商生产的芯片。此项政策出台之际，正值美国刚刚解除一项持续多年的禁令，允许向中国销售采用美国技术制造的先进芯片，包括 AI 芯片巨头英伟达（Nvidia）及其竞争对手 AMD 的产品。然而，美国的政策并未能限制中国，反而刺激了中国半导体行业的投资与创新。
...
故事的核心驱动力在于：美国政府试图阻止中国获得人工智能（AI）技术，认为这项技术将拥有与石油同等重要的地缘政治地位。特朗普总统在 2017 年至 2020 年的首个任期内对此采取了强硬立场，限制中国获取尖端技术，并在整个 2025 年进一步强化了这一政策。然而，美国的这一做法越来越显得难以为继，原因在于：中国的半导体产业取得了令人瞩目的进展；AI 芯片市场的巨大经济价值日益凸显；同时，贸易限制使得英伟达（Nvidia）—— 这家如今已是全球最具价值的公司之一 —— 被挡在了其最大的潜在市场门外。

1 In April, Trump blocked sales to China of Nvidia and AMD's lower-performing chips, which had been designed to satisfy earlier export controls. Nvidia said the tighter restrictions cost the company $5.5 billion.

今年四月，特朗普政府阻止了英伟达（Nvidia）和 AMD 向中国销售其性能较低的芯片，这些芯片原本是为符合早期出口管制规定而设计的。英伟达表示，更严格的出口限制给公司造成了 55 亿美元的损失。

2 China's Huawei CloudMatrix 384 system proved capable of delivering performance that rivals competing Nvidia systems. A cluster of 384 Huawei Ascend 910C chips, the system consumes significantly more energy to power 5 times as many chips as Nvidia's systems.

中国的华为云矩阵 384（Huawei CloudMatrix 384）系统，其性能经证实可与英伟达（Nvidia）的竞争系统相匹敌。该系统集成了 384 颗华为昇腾 910C 芯片，由于芯片数量是英伟达系统的 5 倍，其功耗也显著更高。

3 In August, after Nvidia and AMD met with President Trump, who subsequently met with China's President Xi Jinping, the White House reversed course. The U.S. reauthorized sales to China of made-for-export chips under an unprecedented deal that required U.S. chip vendors to give the government 15 percent of any resulting revenue.

八月，在英伟达（Nvidia）和超微半导体（AMD）与特朗普总统会晤之后，特朗普又与中国国家主席习近平进行了会面，白宫随即转变了立场。美国重新批准了向中国销售专供出口的芯片，依据的是一项前所未有的协议，该协议要求美国芯片供应商将相关收入的 15% 上缴政府。

4 In October, exploding demand for AI hardware temporarily drove Nvidia's market capitalization beyond a staggering $5 trillion, up from $3 trillion in mid-2024. Consequently, shutting the company out of China potentially limited the company's value by tens of billions of dollars.

十月份，人工智能（AI）硬件需求的激增，一度将英伟达（Nvidia）的市值推至惊人的 5 万亿美元以上，而其在 2024 年中期时约为 3 万亿美元。这也意味着，将其拒于中国市场之外，可能使该公司损失了数百亿美元的价值。

5 China responded to the energy-inefficiency of its domestic chips by offering energy subsidies of up to 50 percent to companies that purchased chips made by Huawei and other domestic suppliers. Over the past 15 years, China's ability to generate electrical power has surged while U.S. power generation has remained relatively flat, according to data from the International Energy Association. In 2025, President Trump signed executive orders to make more federal land available for lease and development by the energy industry and to fast track permitting for nuclear reactors.

为应对国产芯片能效较低的问题，中国为购买华为等国内供应商芯片的公司提供了高达 50% 的能源补贴。根据国际能源署的数据，过去 15 年里，中国的发电能力迅猛增长，而美国的发电量则基本保持稳定。2025 年，特朗普总统签署行政命令，开放更多联邦土地供能源行业租赁与开发，并加速核反应堆的审批流程。

6 In November, after China banned U.S. chips, President Trump further softened U.S. restrictions, allowing Nvidia and AMD to sell their made-for-export chips.

十一月，在中国出台对美国芯片的禁令后，特朗普总统进一步放宽了美方限制，允许英伟达和 AMD 销售其出口专用芯片。
...
新闻背后：美国在阻止中国获取最新芯片制造设备方面的努力取得了一些成效。然而，在芯片本身的获取上，事实证明美国设置的壁垒并非密不透风。

1 A thriving market for high-end Nvidia chips sprang up in China's tech hub of Shanzhen.

在中国科技中心深圳，一个繁荣的高端英伟达（Nvidia）芯片市场迅速兴起。

2 Chinese tech giants including Alibaba and ByteDance reportedly gained access to advanced AI computing power through cloud vendors who operate legally in other countries.

据报道，包括阿里巴巴和字节跳动在内的中国科技巨头，通过在其他国家合法运营的云服务商，获取了先进的人工智能（AI）计算能力。

3 DeepSeek reportedly stockpiled earlier Nvidia chips in advance of U.S. restrictions and optimized its DeepSeek-R1 and DeepSeek-V3 models to run well on outdated hardware.

据报道，DeepSeek 在美国实施限制之前，就已预先囤积了旧款英伟达（Nvidia）芯片，并对其 DeepSeek-R1 和 DeepSeek-V3 模型进行了优化，以确保它们能在较旧的硬件上顺畅运行。
...
当前局势：中国正释放出可以摆脱美国硬件的信号。考虑到华为取得的技术突破，这或许彰显了其自信。这也可能是一种虚张声势，因为一些权威评估显示，中国的半导体产业在先进制程芯片的大规模生产方面仍落后数年。无论如何，美国的强硬策略已然适得其反，其放松贸易限制，正是对经济与外交现实的一种让步。
